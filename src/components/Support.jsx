                    ...
                    <li key={ticket.localId} className={`${ticket.priority === "low" && "selectedLow"} ${ticket.priority === "medium" && "selectedMedium"} ${ticket.priority === "high" && "selectedHigh"}`}>
                      {/* ticket options */}
                      {
                        ...
                        <div className='tdl-btnContainer' onClick={() => {
                          ...
                          {/* ticket status */}
                          <div className={`tdl-itemData`} title={`Status: ${ticket.status ?? "pending"}`}>
                            {<>
                              <span>Status:</span>
                              <button disabled={ticket.id === "temp-id"} onClick={(e) => { e.stopPropagation(); editStatusFn(ticket) }}>
                        ...
                        <>
                          {
                            ticketOptions === ticket.id ?
                              <>
                                ...
                                <div className="taskContentAnswer">
                                  Waiting for reply...
                                </div>
                              </> :
                              <>
