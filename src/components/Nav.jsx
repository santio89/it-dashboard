    ...
    <header className="mainHeader">
      ...
      <div className="mainHeader__btnContainer">
        ...
        <div className="themeBtn">
          {user ?
            <>
              <button className="profileBtn" onClick={() => setProfileOpts(!profileOpts)}>
                <img alt="profile-pic" src={user.photoURL} className={profileOpts && "profileOn"} />
              </button>
              {
                profileOpts &&
            ...
            <>
              <button className="profileBtn" onClick={() => setProfileOpts(!profileOpts)}>
                <svg className={profileOpts && "profileOn"} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
