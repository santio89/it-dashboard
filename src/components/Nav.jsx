...
const sections = ["/", "/home", "/about", "/contacts", "/devices", "/tasks", "/support", "/aibot", "/admin"]
...
export default function Nav({ user }) {
  ...
  const toggleBot = () => {
    setBotClicked(true)
    dispatch(setModal({ active: true, data: { modalType: "AIBotDataModal", new: true, user: user } }))
  }
    ...
    <header className="mainHeader">
      ...
      <div className="mainHeader__btnContainer">
        <div className="btnWrapper">
          <button title={lang.askBot} onClick={toggleBot} onAnimationEnd={() => setBotClicked(false)}>
            <svg className={botClicked && "theme-clicked"} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
