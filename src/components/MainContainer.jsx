    ...
    <div className="mainContainer">
      <aside className={`side-panel ${sideExpanded && "expanded"}`}>
        <div className="side-panel__opts">
          ...
          }} title={!sideExpanded && "Home"} to="/" viewTransition>
          ...
          }} title={!sideExpanded && "Contacts"} to="/contacts" viewTransition>
          ...
          }} title={!sideExpanded && "Devices"} to="/devices" viewTransition>
          ...
          }} title={!sideExpanded && "Tasks"} to="/tasks" viewTransition>
          ...
          }} title={!sideExpanded && "Support"} to="/support" viewTransition>
          ...
          }} title={!sideExpanded && "Admin"} to="/admin" viewTransition>
