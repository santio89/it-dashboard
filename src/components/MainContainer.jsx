    ...
    <div className="mainContainer">
      <aside className={`side-panel ${sideExpanded && "expanded"}`}>
        <div className="side-panel__opts">
          <NavLink title={!sideExpanded && "Home"} to="/" viewTransition>
          ...
          <NavLink title={!sideExpanded && "Contacts"} to="/contacts" viewTransition>
          ...
          <NavLink title={!sideExpanded && "Devices"} to="/devices" viewTransition>
          ...
          <NavLink title={!sideExpanded && "Tasks"} to="/tasks" viewTransition>
          ...
          <NavLink title={!sideExpanded && "Support"} to="/support" viewTransition>
          ...
          <NavLink title={!sideExpanded && "Admin"} to="/admin" viewTransition>
        ...
        <button title="Toggle layout" className={`side-toggle ${sideExpanded && "expanded"}`} onClick={() => { expandSide() }}>
