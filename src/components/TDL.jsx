          ...
          isLoadingTdl ? <div className="loader">Loading...</div> :
            <div className="listWrapper">
              <ul className='tdl-list' ref={listContainer}>
                {
                  tdlList?.map((task) =>
                    <li key={task.id} disabled={taskOptions === task.id && (resultEditTdl.isLoading)}>
                      {/* priority btn */}
                      {taskOptions === task.id &&
                      ...
                      {/* task options */}
                      {
                        ...
                        <div className='tdl-btnContainer' onClick={() => {
                          ...
                          <div className={`tdl-itemData `}>
                            {<>
                              <button disabled={isFetchingTdl} title={`Status: ${editStatus ?? "not done"}`} onClick={(e) => { e.stopPropagation(); editStatusFn(task) }}>
