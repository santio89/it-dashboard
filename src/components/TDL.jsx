                      ...
                      {/* task options */}
                      {
                        ...
                        <div className='tdl-btnContainer' onClick={() => {
                          ...
                          <div className={`tdl-itemData `}>
                            {<>
                              <span>Status:</span>
                              <button disabled={isFetchingTdl || task.id === "temp-id"} title={`Status: ${task.status ?? "not done"}`} onClick={(e) => { e.stopPropagation(); editStatusFn(task) }}>
                          ...
                          <div className={`tdl-optionsBtns`}>
                            {
                              /* open */
                              <button disabled={isFetchingTdl || task.id === "temp-id"} title={"Info"} onClick={(e) => { e.stopPropagation(); dispatch(setModal({ active: true, data: { modalType: "TDLDataModal", tdlData: true, ...task, dataList: dataTdl } })); setListPickerOpen(false) }}>
                        ...
                        <>
                          {
                            taskOptions === task.id ?
                              ...
                              <>
                                <button disabled={isFetchingTdl || task.id === "temp-id"} title={task.title} className={`taskContentBtn ${taskOptions !== task.id && task.priority === "low" && "selectedLow"} ${taskOptions !== task.id && task.priority === "medium" && "selectedMedium"} ${taskOptions !== task.id && task.priority === "high" && "selectedHigh"} ${taskOptions === task.id && "taskOption"} ${task.status === "done" && "taskDone"}`} onClick={() => {
