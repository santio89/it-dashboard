    ...
    <div className="mainContainer">
      <aside className={`side-panel ${sideExpanded && "expanded"}`}>
        <div className="side-panel__opts">
          <NavLink title={!sideExpanded && "Home"} to="/">
          ...
          <NavLink title={!sideExpanded && "Contacts"} to="/contacts">
          ...
          <NavLink title={!sideExpanded && "Devices"} to="/devices">
          ...
          <NavLink title={!sideExpanded && "Tasks"} to="/tdl">
          ...
          <NavLink title={!sideExpanded && "Support"} to="/support">
          ...
          <NavLink title={!sideExpanded && "Admin"} to="/admin">
